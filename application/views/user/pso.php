                            ...
                            <div class="row">
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="c1" aria-describedby="c1" name="c1">
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        <label for="c2">Nilai C2</label>
                                        <input type="text" class="form-control" id="c2" aria-describedby="c2" name="c2">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="bobot_inersia" aria-describedby="bobot_inersia" name="bobot_inersia">
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        <label for="k">Nilai K</label>
                                        <input type="text" class="form-control" id="k" aria-describedby="k" name="k">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="p" aria-describedby="p" name="p">
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        <label for="epoch">Epoch</label>
                                        <input type="text" class="form-control" id="epoch" aria-describedby="epoch" name="epoch">
                                    </div>
                                </div>
                            </div>
